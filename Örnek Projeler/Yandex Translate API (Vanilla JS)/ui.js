...
UI.prototype.change = function(img, word){ //UI'in prototipine change metodu ekliyorum, app.js'de gönderdiğim iki veriyi burada karşılıyorum
    this.outputLang.textContent = document.querySelector("#translate-form .selected").textContent; //zihnisinir bir yöntemle dropdown-listimde seçili olan seçeneğin adını buraya alıyorum, böylece yeni dil seçenekleri eklemek çok kolay olacak
